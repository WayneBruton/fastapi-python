mainHeading1 = "**THE PARTIES HEREBY CONTRACT AND AGREE WITH ONE ANOTHER AS SET OUT HEREUNDER**"
heading1 = "**1. DEFINITIONS AND INTERPRETATION**"
point1 = "In this Agreement, unless the context clearly indicates a contrary meaning, the undermentioned words and " \
         "phrases shall bear the meanings attributed to them in this clause. "
point1_1 = "**'This Agreement'** means this Development Investment Loan Agreement and all annexures hereto."
point1p1p1 = "Annexure 'A' - Draft Site Development Plan;"
point1p1p2 = "Annexure 'B' - Draft Sectional Building Plans;"
point1p1p3 = "Annexure 'C' - Instruction Mandate;"
point1p2 = "**'Annexures'** means the following annexures which form an integral part of the Agreement"
point1p3 = "**'Attorneys'** means Ilismi Du Toit of LAÄS & SCHOLTZ INC, Queen Street Chambers, 33 Queen Street, " \
           "Durbanville;  Tel:  021 975 0802;  E-mail:  ilismi@lslaw.co.za"
point1p4 = "**Attorneys' Trust Account** means the following trust account of the Attorneys:"
point1p41 = "Name of Account:"
point1p42 = "LAÄS & SCHOLTZ INC"
point1p43 = 'Bank:'
point1p44 = "STANDARD BANK"
point1p45 = 'Branch:'
point1p46 = "PAROW CENTRE"
point1p47 = 'Branch code:'
point1p48 = "051001"
point1p49 = 'Account Number:'
point1p50 = "27 22 555 05"
point1p51 = 'Client Ref:'
point1p52 = "HERON / SURNAME"
point1p5 = "**'Business Hours'** means the hours between 08h30 and 17h00 on any business day. Any reference to time " \
...
point1p15 = "**'Investment Account Supplemented Interest'** means the interest earned on the Loan Amount payable by " \
            "the Borrower to the Lender, which interest is calculated at 2.75% (Two Point Seven Five Percent) above " \
            "the prevailing bank repo rate (simple interest per annum), adjusted the 1st (First) day of the month " \
            "following any changes in the bank repo rate; "
point1p16 = "**'Investment Date'** means the date on which the Attorneys transfer the Loan Amount to the Investment " \
            "Account. "
...
point1p23 = "**'Property'** per Investment Information Schedule on page 2 as shown and more fully described on the " \
            ...
            "size of the Property is subject to final approval by the relevant local authority and accordingly may " \
            "change; "
point1p24 = "**'Proposed Development'** means the implementation and establishment of an approved sectional title " \
            "scheme(s) in various phases on the Development Land, comprising 166 sectional title units as per the " \
            "Annexures, together with all necessary services and infrastructure; "
point1p25 = "**'Protection of Personal Information Act'** means the Protection of Personal Information Act 4 of 2013;"
point1p26 = "**'Release Date'** means the date on which the Loan Amount, Investment Account Interest or any portion " \
            "thereof is released from the Investment Account to the Borrower for purposes of funding the Proposed " \
            "Development, which release will only happen upon instruction from NSST; "
point1p27 = "**'Repayment Date'** means the date of which the Loan Amount plus Interest thereon has been repaid to " \
            "the Lender, which can be any of the following:\n\n1.1.27.1 date of registration of transfer of the " \
            "Property; \n1.1.27.2 date of sale of Development Land;\n1.1.27.3 Any date prior to the events mentioned " \
            "in Clauses 1.1.27.1 or 1.1.27.2 which payment is at the sole discretion of the Borrower. "
point1p28 = "**'Repayment Notice'** means, subject to the Status Report, notice may be given by NSST to the Borrower " \
            "to make repayment of the Loan Amount plus interest thereon to the Lender within a specified timeframe, " \
            "failing which NSST, at their discretion and acting in the best interests of the Lender, may call on the " \
            "security provided for in the covering mortgage bond and act on the provisions provided for in the Loan " \
            "Agreement to effect repayment to the lender; "
point1p29 = "**'Signature Date'** means the date of signature of the last signing party to this Agreement;"
point1p30 = "**'Status Report'** means report called for from the Borrower by NSST on the status of the development " \
            "to determine when repayment of the Loan Amount plus interest to the Lender will take place and to " \
            "establish the best course of action, which report will be called for 24 months after the Release Date " \
            "and will be delivered to NSST within 21 business days by the Borrower; "
point1p31 = "**'Total Loan'** means the sum of all loan amounts advanced to the Borrower by various investors for the " \
            "purpose of funding the Proposed Development; "
point1p32 = "**'VAT'** means Value-added Tax levied from time to time in terms of the Value-added Tax Act, No. 89 of " \
            "1991, as amended."
point2 = "Words importing the singular shall include the plural and vice versa, words importing the masculine gender " \
         "shall include the feminine and neuter genders, and words importing persons shall include partnerships and " \
         "legal entities and vice versa. "
point3 = "The head notes to the paragraphs in this Agreement are inserted for reference purposes only and shall not " \
         "affect the interpretation of any of the provisions to which they relate. "
point4 = "A reference to any statutory enactment shall be construed as a reference to that enactment as at the " \
         "Signature Date and as amended or substituted from time to time. "
point5 = "Unless specifically otherwise provided, any number of days prescribed shall be determined by excluding the " \
         "first and including the last day or, where the last day falls on a day that is not a business day, " \
         "the next succeeding business day. "
point6 = "If the due date for performance of any obligation in terms of this Agreement is a day which is not a " \
         "business day then (unless otherwise stipulated) the due date for performance of the relevant obligation " \
         "shall be the immediately preceding business day. "
point7 = "Where figures are referred to in numerals and in words, and there is any conflict between the two, " \
         "the words shall prevail, unless the context indicates a contrary intention. "

heading2 = "**2. INTRODUCTION**"

point2_1 = "The Borrower is or is about to become the registered owner of the Development Land."

point2_2 = "The Borrower requires the Loan Amount for purposes of partly funding the Proposed Development."

point2_3 = "The Lender has agreed to advance the Loan Amount to the Borrower as an investment against security of:"
point2_3_1 = "the registration of a covering mortgage bond over the Development Land in favour of NSST; and"
point2_3_2 = "registration of transfer of the linked Property."

point2_4 = "The Parties wish to record their agreement in respect of the above and matters ancillary thereto in " \
           "writing. "

heading3 = "**3 THE LOAN**"
point3_1 = "In order to fund the Proposed Development, the Borrower intends to obtain the Total Loan from various " \
           "investors. "

point3_2 = "It is recorded that all loan amounts advanced by investors to the Borrower for purposes of funding the " \
           "Proposed Development, together with the Loan Amount advanced by the Lender, shall constitute the Total " \
           "Loan. "

point3_3 = "It is further recorded that the sum total of the Loan Amount and all other loan amounts advanced by " \
           "various investors which are linked to the Property may not exceed the Development Amount by more than " \
...
heading11a = "Should any Party fail to fulfill any of the terms and conditions of this Agreement ('the defaulting " \
             ...
             "'the aggrieved party') has delivered a written notice to the defaulting party specifying the breach and " \
             "demanding that it be rectified, the aggrieved party may without further notice and without prejudice to " \
             "his/her rights: "

point11_1 = "claim specific performance by the defaulting party of all his/her obligations under this Agreement; or"
point11_2 = "cancel this Agreement and claim damages from the defaulting party that may have been suffered as a " \
            "result of the breach. "

heading11b = "Any latitude which may have been allowed by the aggrieved party in respect of any breach by the " \
             "defaulting party in terms hereof, shall not under any circumstances be deemed to be a waiver of the " \
             "aggrieved party's rights under this Agreement nor a novation hereof, nor shall it prevent the aggrieved " \
...
point13_1 = "The Parties to this Agreement choose the following addresses as their respective __domicilia citandi et " \
...
point13_1_3 = "NSST at:\nC/O of LAÄS & SCHOLTZ INC,\nQUEEN STREET CHAMBERS, 33 QUEEN STREET, DURBANVILLE\nEmail " \
              "Address: deon@nobleshield.co.za "

point13_2 = "Any notice or communication required or permitted in terms of this Agreement shall be valid and " \
            "effective only if in writing but it shall be competent to give such notice by email. "

point13_3 = "Either Party may by notice to the other change the physical address chosen as domicilium or change the " \
            "email address; provided that such change(s) shall only become effective on the sixth business day after " \
            "the date of receipt, or deemed date of receipt, of such notice by the addressee. "

point13_4 = "Any notice to a Party shall -"
point13_4_1 = "If sent by pre-paid registered post, be deemed to have been received on the sixth business day after " \
              "posting, unless the contrary is proved. "

point13_4_2 = "If delivered by hand, shall be deemed to have been received on the day of delivery or on the next " \
              "business day if the day of delivery is not a business day. "

point13_4_3 = "If sent by email, shall be deemed to have been received on the date of dispatch or on the next " \
              "business day if the time of dispatch is not on a business day, unless the contrary shall otherwise be " \
              "proved. "

point13_4_4 = "Notwithstanding anything to the contrary herein contained, a written notice or communication actually " \
              "received by a Party to this Agreement shall be an adequate written notice or communication to it, " \
