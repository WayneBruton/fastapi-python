...
# loop through the data and add 0.00 four times to the amount list
# for i in range(0, 4):
#     for data in base_data:
#         data["Amount"].append(0.00)
#     for data in base_data_HF_PandL:
#         data["Amount"].append(0.00)
#     for data in base_data_HV_PandL:
#         data["Amount"].append(0.00)

# print(base_data_HV_PandL[len(base_data_HV_PandL) - 2]["Amount"])
