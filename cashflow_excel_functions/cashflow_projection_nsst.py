    ...
    try:
        ...
        for index, col in enumerate(month_headings):
            ...
            if index == 0:
                ...
                ws6[f"{col}{vat_row}"] = f"=IF(MOD(MONTH({col}5),2)=0,0,((+{month_headings[index - 3]}{refinanced_units_start - 1}+{month_headings[index - 1]}{refinanced_units_start + 4})*156521.739130435))"
                # ws6[
                #     f"{col}{vat_row}"] = 0
